package com.oxied.pickimage.resolver;
...
import com.oxied.pickimage.keep.Keep;
import com.oxied.pickimage.provider.PhotoProvider;
...
public class IntentResolver {
    ...
    public Uri cameraUri() {
        return PhotoProvider.getPhotoUri(getAuthority(), cameraFile());
    }
